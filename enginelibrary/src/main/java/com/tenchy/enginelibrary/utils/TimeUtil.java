...
public class TimeUtil {
    ...
    public static String timestamp() {
        return NowString("yyyyMMddHHmmssSSS");
    }
    ...
    public static String NowString(String format) {
        return toDateTime(System.currentTimeMillis(), format);
    }

    public static long toTime(String dateTime) {
        return toTime(dateTime, "yyyy-MM-dd HH:mm:ss");
    }

    @SuppressLint({ "SimpleDateFormat" })
    public static long toTime(String dateTime, String format) {
    ...
    public static String toDateTime(long time, String format) {
        if ((format == null) || (format.equals("")))
            return "";
        SimpleDateFormat df = new SimpleDateFormat(format);
        String dateTime = df.format(Long.valueOf(time));
        return dateTime;
    }
